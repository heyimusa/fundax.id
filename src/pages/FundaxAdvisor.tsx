...
const advisors: Advisor[] = [
  {
    id: '1',
    name: 'Maria Sari',
    office: 'Loan Market Harmony',
    city: 'Jakarta',
    specialization: ['KPR', 'Take Over'],
  ...
  },
  {
    id: '2',
    name: 'Erry Elmar',
    office: 'Loan Market Prioritas',
    city: 'Jakarta',
    specialization: ['KPR', 'Multiguna', 'Modal Usaha'],
    phone: '+62 812-3456-7891',
    email: 'erry.elmar@fundax.co.id',
    rating: 5,
    location: [-6.2297, 106.7970],
  },
  {
    id: '3',
    name: 'Budi Santoso',
    office: 'Loan Market Bandung',
    city: 'Bandung',
    specialization: ['KPR', 'Deposito'],
    phone: '+62 812-3456-7892',
    email: 'budi.santoso@fundax.co.id',
    rating: 4.5,
  ...
  },
  {
    id: '4',
    name: 'Siti Nurhaliza',
    office: 'Loan Market Surabaya',
    city: 'Surabaya',
    specialization: ['KPR', 'Multiguna', 'Investasi'],
    phone: '+62 812-3456-7893',
    email: 'siti.nurhaliza@fundax.co.id',
    rating: 5,
  ...
  },
  {
    id: '5',
    name: 'Ahmad Fauzi',
    office: 'Loan Market Yogyakarta',
    city: 'Yogyakarta',
    specialization: ['Modal Usaha', 'KPR'],
    phone: '+62 812-3456-7894',
    email: 'ahmad.fauzi@fundax.co.id',
    rating: 4.8,
  ...
  },
  {
    id: '6',
    name: 'Lisa Wijaya',
    office: 'Loan Market Semarang',
    city: 'Semarang',
    specialization: ['Take Over', 'Deposito'],
    phone: '+62 812-3456-7895',
    email: 'lisa.wijaya@fundax.co.id',
    rating: 4.7,
...
const specializations = ['KPR', 'Take Over', 'Multiguna', 'Modal Usaha', 'Deposito', 'Investasi'];
